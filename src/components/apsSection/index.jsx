    ...
    <div className=" relative bg-secondary py-20">
        ...
        <div className=" flex flex-wrap gap-2 justify-center pt-8 ">
        {
            data.slice(0,3).map((e)=> {
                return (
                    <div key={e?.id} className=" max-w-fit relative border mx-2 rounded-xl overflow-hidden ">
                     <button
                    ...
                    <img src={e.image} className="max-w-[350px] w-[350px]" alt="" />
                    <div className=" bg-[#1B2125] text-white px-2 relative min-h-[150px] max-w-[350px] z-[1000]">
                        <h3 className=" font-bold text-base">{e.title}</h3>
                        <p className=" text-sm">{e.dec.slice(0,50)}..</p>
                        <div className=" text-center pb-2">
                            <button className=" bg-primary text-white rounded-xl py-2 px-4 my-4 relative " onClick={()=> navigate('/offerings-solutions')}>Know More</button>
                        </div>
                    </div>
                </div>
                )
