...
export default function Footer() {
  ...
  return (
    <>
      <div className=" bg-[#1B2125] relative z-100 py-10 px-20">
        <div className=" flex flex-col justify-center items-center lg:justify-start lg:items-start  lg:flex-row gap-28">
          ...
          <ul className=" text-white">
            ...
            <li className=" mb-2 font-light cursor-pointer" onClick={()=> navigate("")}>Pricing</li>
      ...
      <div className=" border-t bg-[#1B2125] lg:px-20 px-4 py-4 text-white font-thin border-white/20 mt-4">
